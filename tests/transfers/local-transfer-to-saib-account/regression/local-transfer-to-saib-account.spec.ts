...
import { LocalTransferToSaibAccountPage } from '../../../../pages/transfers/portal/LocalTransferToSaibAccountPage.js';
...
test.describe('Local Transfers - To Another SAIB Account', () => {
  ...
  test('SAIB-1803 - Correct To Another SAIB Account form is displayed', async ({ page }, testInfo) => {
    try {
      ...
      await handleFailureEvidence(page, testInfo, 'SAIB-1803-local-transfer-saib-form');
      throw error;
    }
  });
  ...
  test('SAIB-1804 - Selected source account displays available balance and currency', async ({ page }, testInfo) => {
    try {
      ...
      await handleFailureEvidence(page, testInfo, 'SAIB-1804-local-transfer-saib-source-account');
      throw error;
    }
  });
  ...
  test('SAIB-1806 - Add New beneficiary opens locked Another SAIB Account Number popup', async ({ page }, testInfo) => {
    try {
      ...
      await handleFailureEvidence(page, testInfo, 'SAIB-1806-local-transfer-saib-add-new-beneficiary');
      throw error;
    }
  });
  ...
  test('SAIB-1807 - Transfer limits panel updates after entering transfer amount', async ({ page }, testInfo) => {
    try {
      ...
      await handleFailureEvidence(page, testInfo, 'SAIB-1807-local-transfer-saib-amount-limits');
      throw error;
    }
  });
  ...
  test('SAIB-1808 - Quick-add amount buttons increment amount correctly', async ({ page }, testInfo) => {
    try {
      ...
      await handleFailureEvidence(page, testInfo, 'SAIB-1808-local-transfer-saib-quick-amount');
      throw error;
    }
  });
  ...
  test('SAIB-1809 - Selected Reason for Transfer appears in transfer summary', async ({ page }, testInfo) => {
    try {
      ...
      await handleFailureEvidence(page, testInfo, 'SAIB-1809-local-transfer-saib-reason');
      throw error;
    }
  });
  ...
  test('SAIB-1805 - Saved SAIB beneficiary name appears partially masked', async ({ page }, testInfo) => {
    try {
      ...
      await handleFailureEvidence(page, testInfo, 'SAIB-1805-local-transfer-saib-beneficiary-masking');
      throw error;
    }
  });
  ...
  test('SAIB-1810 - Instant schedule with accepted terms opens review or OTP screen without executing transfer', async ({ page }, testInfo) => {
    try {
      ...
      await handleFailureEvidence(page, testInfo, 'SAIB-1810-local-transfer-saib-instant-review-or-otp');
      throw error;
    }
  });
  ...
  test('SAIB-1814 - Scheduled transfer selection appears as Scheduled in review', async ({ page }, testInfo) => {
    try {
      ...
      await handleFailureEvidence(page, testInfo, 'SAIB-1814-local-transfer-saib-scheduled-review');
      throw error;
    }
  });
  ...
  test('SAIB-1815 - Recurring transfer selection creates recurring summary', async ({ page }, testInfo) => {
    try {
      ...
      await handleFailureEvidence(page, testInfo, 'SAIB-1815-local-transfer-saib-recurring-review');
      throw error;
    }
  });
  ...
  test('SAIB-1816 - Same-currency source and beneficiary proceeds without currency error', async ({ page }, testInfo) => {
    try {
      ...
      await handleFailureEvidence(page, testInfo, 'SAIB-1816-local-transfer-saib-same-currency');
      throw error;
    }
  });
  ...
  test('SAIB-1817 - Multiple beneficiaries appear as separate selectable rows', async ({ page }, testInfo) => {
    try {
      ...
      await handleFailureEvidence(page, testInfo, 'SAIB-1817-local-transfer-saib-multiple-beneficiaries');
      throw error;
    }
  });
  ...
  test('SAIB-1818 - Projected balance reflects source balance minus transfer amount', async ({ page }, testInfo) => {
    try {
      ...
      await handleFailureEvidence(page, testInfo, 'SAIB-1818-local-transfer-saib-projected-balance');
      throw error;
    }
  });
  ...
  test('SAIB-1819 - EGP to USD beneficiary currency mismatch is blocked before posting', async ({ page }, testInfo) => {
    try {
      ...
      await handleFailureEvidence(page, testInfo, 'SAIB-1819-local-transfer-saib-currency-mismatch');
      throw error;
    }
  });
  ...
  test('SAIB-1820 - Transfer amount exceeding available balance is blocked', async ({ page }, testInfo) => {
    try {
      ...
      await handleFailureEvidence(page, testInfo, 'SAIB-1820-local-transfer-saib-insufficient-balance');
      throw error;
    }
  });
});
