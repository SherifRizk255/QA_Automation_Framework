...
export class PayMyCardTransferLogPage extends BaseCrmPage {
  ...
  async assertTransferTypePayMyCard(): Promise<void> {
    const typeLabel = this.page.getByText('Pay My Card', { exact: true });
