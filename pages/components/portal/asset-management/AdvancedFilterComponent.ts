...
export class AdvancedFilterComponent {
  ...
  private toggle(): Locator {
    return this.repository.locator('ASSET.TAGGING.FILTERS.TOGGLE');
  }

  private panel(): Locator {
    return this.repository.locator('ASSET.TAGGING.FILTERS.PANEL');
  }

  private applyButton(): Locator {
    return this.repository.locator('ASSET.TAGGING.FILTERS.APPLY_BUTTON', { scope: this.panel() });
  }

  private resetButton(): Locator {
    return this.repository.locator('ASSET.TAGGING.FILTERS.RESET_BUTTON', { scope: this.panel() });
  }

  private activeFilterChips(): Locator {
    return this.repository.locator('ASSET.TAGGING.FILTERS.ACTIVE_FILTER_CHIP', { scope: this.panel() });
  }

  private field(fieldLabel: string): Locator {
    return this.repository.locator('ASSET.TAGGING.FILTERS.FIELD', {
      scope: this.panel(),
